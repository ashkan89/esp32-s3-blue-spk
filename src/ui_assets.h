...
/*
 * A waning crescent, for the standby screen.
 *
 * A moon rather than a power symbol on purpose: a circle-and-bar reads as "this
 * is switched off", which would be a lie -- the board is still drawing about
 * 15 mA and is watching the button. A moon reads as "asleep, press to wake",
 * which is what actually happens. The stars beside it are drawn in code so they
 * can twinkle without a second bitmap.
 */
static const uint8_t ICON_MOON[16] = {
    xr(0b00000111), xr(0b11000000),  // .....#####......
    xr(0b00011111), xr(0b11100000),  // ...#########....
    xr(0b00111111), xr(0b00000000),  // ..######........
    xr(0b01111100), xr(0b00000000),  // .#####..........
    xr(0b01111000), xr(0b00000000),  // .####...........
    xr(0b01111000), xr(0b00000000),  // .####...........
    xr(0b01111100), xr(0b00000000),  // .#####..........
    xr(0b00111111), xr(0b00000000),  // ..######........
};
